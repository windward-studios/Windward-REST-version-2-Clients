...
import base64
'''
 * Template. This is what is sent to the server to make a request.<br/>
 * This makes use of @JacksonXmlProperty for all properties because they must be correctly capitalized in a request (in
 * a response we ignore capitalization).
'''
